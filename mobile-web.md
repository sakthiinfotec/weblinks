...
[Microsoft - Human AI interaction](https://www.microsoft.com/en-us/research/project/guidelines-for-human-ai-interaction)  
...
[Toptal - Creating a Secure REST API in Node.js/Express](https://github.com/makinhs/expressjs-api-tutorial)  
...
[The last guide to the useEffect Hook you’ll ever need - logrocket](https://blog.logrocket.com/guide-to-react-useeffect-hook/)  
...
[FeatherIcons - Using with React Native](https://dev.to/stephencavender/react-native-svg-example-413j)  
[CryptoJS](https://cryptojs.gitbook.io/docs/)  
[n8n - Extendable Workflow Automation Tool](https://n8n.io/)  
...
[RemoveBg - Remove Background from Image for Free](https://www.remove.bg/)  
[Designify - Turn Any Photo Into Awesome - 100% Automatically and Free](https://www.designify.com/)  
...
[Vuforia - AR/VR](https://www.ptc.com/en/products/vuforia)  
...
[Hono - Web application framework | Works on Cloudflare, Fastly, Deno, Bun, AWS, or Node.js](https://hono.dev/)  
...
- [Vaul is an unstyled drawer component for React that can be used as a Dialog replacement on tablet and mobile devices](https://vaul.emilkowal.ski/)
- [Radix - An open-source component library optimized for fast development, easy maintenance, and accessibility](https://www.radix-ui.com/)  
...
[Owl Carousel for JQuery](https://owlcarousel2.github.io/OwlCarousel2/index.html)
[uilabs.dev - Ract, Tainwind, Framer Motion](https://www.uilabs.dev/)
